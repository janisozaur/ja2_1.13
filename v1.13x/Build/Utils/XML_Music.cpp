...
//	{
//		if(strcmp(name, "MUSICDLIST") == 0 && pData->curElement == ELEMENT_NONE)
//		{
//			pData->curElement = ELEMENT_LIST;
//
//			pData->maxReadDepth++; //we are not skipping this element
//		}
//		else if(strcmp(name, "MUSIC") == 0 && pData->curElement == ELEMENT_LIST)
//		{
...
//				szMusicList[pData->curIndex] = temp;
//			}
//		}
//
//		pData->maxReadDepth--;
...
//	// Open a new file
//	hFile = FileOpen( "TABLEDATA\\Music out.xml", FILE_ACCESS_WRITE | FILE_CREATE_ALWAYS, FALSE );
//	if ( !hFile )
//		return( FALSE );
//	
//	{
//		UINT32 cnt;
//
//		FilePrintf(hFile,"<MUSICLIST>\r\n");
//		for(cnt = 0;cnt < NUM_SAMPLES;cnt++)
//		{
//			FilePrintf(hFile,"\t<MUSIC>");
//
//			char * szRemainder = szMusicList[cnt]; //the remaining string to be output (for making valid XML)
//
...
//			}
//
////			FilePrintf(hFile,"\t\t<MUSIC>%s</MUSIC>\r\n",						szSoundEffects[cnt]);
//
//			FilePrintf(hFile,"</MUSIC>\r\n");
//		}
//		FilePrintf(hFile,"</MUSICLIST>\r\n");
